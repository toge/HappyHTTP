...
#ifndef HAPPYHTTP_HAPPYHTTP_H_
#define HAPPYHTTP_HAPPYHTTP_H_
...
public:
    ...
    void putheader(const char* header, int numericvalue) {
        char buf[32];
        std::snprintf(buf, sizeof(buf), "%d", numericvalue);
